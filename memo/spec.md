...
## CI Strategy
- **Trigger**: GitHub Actions on push to `main`, `develop`, or `release`. Tag pushes matching `r*` also trigger the workflow for release asset uploads. Manual runs use `workflow_dispatch`.
